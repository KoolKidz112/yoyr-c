...
//	   PENIS START
//======================
void EV_PenisFire(event_args_t *args) {
	int idx;
	Vector origin;
	Vector angles;
	Vector velocity;
	...
	gEngfuncs.pEventAPI->EV_PlaySound(idx, origin, CHAN_WEAPON, "weapons/pl_flurp.wav", gEngfuncs.pfnRandomFloat(0.92, 1.0), ATTN_NORM, 0, 98 + gEngfuncs.pfnRandomLong(0, 3));
