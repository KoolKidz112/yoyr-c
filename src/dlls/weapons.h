...
#define PENIS_WEIGHT        GLOCK_WEIGHT
...
#define PENIS_MAX_CLIP			GLOCK_MAX_CLIP
...
#define PENIS_DEFAULT_GIVE          GLOCK_DEFAULT_GIVE
...
class CPenis : public CBasePlayerWeapon
{
public:
	void Spawn() override;
	void Precache() override;
...
private:
	unsigned short m_usFirePenis;
	unsigned short m_usFirePenisRocket;
};
